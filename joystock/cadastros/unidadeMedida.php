<?php
	...
	$frmMaster			 = 'unidadeMedida.php';							
	$NME_FRM 			 = 'index';
	$DSC_FRM             = 'Cadastro de Unidade de Medida';
	$ACTION 			 = 'unidadeMedida.php';
	$_SESSION['NME_RTN'] = "/joystock/cadastros/unidadeMedida.php";
	$TABELA              = "upcsumd_tb";
	
	
	require_once(PATH_FUNCAO."/CTRLReg.php");
	
	$select = "SELECT T1.COD_UMD, T1.DSC_RSM,  T1.DSC_UMD ".
			  "FROM upcsumd_tb T1 ".
			  "WHERE T1.EXC_UPCSUMD IS NULL ";

	$_SESSION['query_lista'] = $select." ORDER BY DSC_UMD";
	
	$_SESSION['link_title'] = 'COD_UMD'; // fazer aparecer o title na lista
	
	/* Cria��o e Defini��o de colunas para lista */
	$_SESSION['prop'][0] = array('campo' => 'COD_UMD','format' => 'ZeroEsquerda','funcao' => '','link'=>'COD_UMD','propriedade' => 'vertical-align: top; text-align: center; width: 10%; font-size:100%;');
	$_SESSION['prop'][1] = array('campo' => 'DSC_UMD','funcao' => '','link'=>'COD_UMD','propriedade' => 'vertical-align: top; text-align: left; width: 45%; font-size:100%;');
	$_SESSION['prop'][2] = array('campo' => 'DSC_RSM','funcao' => '','link'=>'COD_UMD','propriedade' => 'vertical-align: top; text-align: left; width: 45%; font-size:100%;');
		...
		<center>
			...
			<fieldset  style=" background-color:#FFFFFF;  width:600px; height:420px;  border-style: solid;border-width:2px; border-color:#<?=COR?>;  z-index: 11;">
				...
				<?
					...
					echo $breg->defineBreg("novo","salvar","editar","cancelar","","");	
			...
			<table  style="margin-top:25px" id="LBL" width='100%'>
			  ...
			  <tr>	
			  	<td style="padding-top:15px" width="34%" align="right">Unidade de Medida:</td>
			  	<td style="padding-top:15px">
			  		<input maxlength="80" style="width:160px" <?=$CPO['DSC_UMD']?>  type='text' name='DSC_UMD'>
			  		Desc. Reduzida:
			  		<input maxlength="3" style="width:50px" <?=$CPO['DSC_RSM']?>  type='text' name='DSC_RSM'>
			  	</td>
			  </tr>
			  <tr>	
