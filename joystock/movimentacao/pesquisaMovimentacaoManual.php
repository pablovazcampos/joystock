<?
	...
	$colunas = new listaPesquisa("Pesquisa Movimentação Manual","/joystock/movimentacao/movimentacaoManual.php");
	$colunas->criaColuna("COD_MMN", $_POST['COD_MMN'], "Código", "80", "codigo", "fiveFormat", "", "center");
	$colunas->criaColuna("DTA_MMN", $_POST['DTA_MMN'], "Data", "100", "data", "", "", "center", $_POST['DTA_MMN2']);
	$colunas->criaColuna("NME_PRD", $_POST['NME_PRD'], "Produto", "380", "texto", "", "", "center");
	$colunas->criaColuna("TPO_MMN", $_POST['TPO_MMN'], "Tipo", "120", "select", $tipoMovimento, "Natureza", "center");
	$colunas->criaColuna("QTD_PRD", $_POST['QTD_PRD'], "Quantidade", "120", "valor", "", "", "center", $_POST['QTD_PRD2']);
	...
	$query = "SELECT T1.COD_MMN, T1.DTA_MMN, T2.NME_PRD, T1.QTD_PRD, T1.TPO_MMN  FROM upcsmmn_tb T1 ".
			 ...
			 "WHERE T1.EXC_UPCSMMN IS NULL {$colunas->getWhere()} ORDER BY COD_MMN DESC LIMIT {$pag->getLimit()},{$linhas}";
						...
						<table width="100%" height="100%" cellpadding="0" cellspacing="0">
							<tr  style="position:relative;  " height="30px" width="100%" >
								<td valign="top" id="letra" style="font-size:30px; padding-left:10px " colspan="12" align="left">
									...
									<div style="float:left; padding-top:4px; width:480px">
										<?=$colunas->getTitulo()?>
									</div>
								</td>
