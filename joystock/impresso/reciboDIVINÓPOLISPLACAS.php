<?php
    ...
    if (!empty($_GET['COD'])) {
		...
		$pdf->Ln(3);
		$pdf->Cell(190,7,utf8_decode("Divinópolis Placas"),1,1,'C',0,'');
		$pdf->Ln(1);
		$pdf->SetFont("arial", '', 8);
		$pdf->Cell(90,3,utf8_decode("Rua Goiás, 1.849 - Ipiranga"),0,1,'C',0,'');
		$pdf->Cell(90,3,utf8_decode("Tel.: (37) 3216-3237"),0,0,'C',0,'');
		$pdf->SetFont("arial", 'B', 15);
		...
		$pdf->SetFont("arial", '', 8);
		$pdf->Cell(90,3,utf8_decode("CEP: 35502-027 - DIVINÓPOLIS - MINAS GERAIS"),0,1,'C',0,'');
		...
		$pdf->Cell(110,5,'Produto',1,0,'C',1,0);
		$pdf->Cell(20,5,'Placa',1,0,'C',1,0);
		...
		while ($row = @mysql_fetch_array($dados)){
			...
			$pdf->Cell(110,5,$row['NME_PRD'],1,0,'L',0,0);
			$pdf->Cell(20,5,$row['HST_PRD'],1,0,'C',0,0);
