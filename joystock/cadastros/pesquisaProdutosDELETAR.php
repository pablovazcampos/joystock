<?
	...
	$query = "SELECT * FROM upcsprd_tb T1 ".
			 "WHERE T1.EXC_UPCSPRD IS NULL AND TPO_PRD = '1' $where ORDER BY NME_PRD LIMIT {$pag->getLimit()},20";
					...
					<div id="mLogin" style="height:100%; width:100%; overflow-y:auto; overflow-x:hidden">
						<table width="100%" height="97%" cellpadding="0" cellspacing="0">
							<tr  style="position:relative;  " height="30px" width="100%" >
								<td valign="top" id="letra" style="font-size:30px;  " colspan="12" align="center">Pesquisa de Produtos Simples</td>
								<div style="position:absolute;right:5px; padding:2px ">
									<img id="box1" title="Atualizar"    onclick="location.href='/joystock/cadastros/pesquisaProdutos.php'" style="width:28px; cursor:pointer; height:28px;" src="/joystock/pcte-common/images/actualiser.png">
								...
								<td>
									...
									<table width="100%" height="100%">
										<tr   id="letra" height="30px"  valign="top" style="font-size:13px" >
											...
											<td style="position:relative" align="center" width="120px">
											...
											<td style="position:relative" id="titlelist" align="center" width="120px">
												<div id="quantidade" class="titleBlt"  style="position:absolute; width:100%; height:30px; border-radius:0px 0px 2px 2px; left:0px; top:0px; ">	
													Em Estoque
													<input class="decimal4Format" autocomplete="off" onblur="setTimeout(function(){desFiltros('quantidade', '30')},200)" name="QTD_PRD" value="<?=$_POST['QTD_PRD']?>" onclick="filtros('quantidade', '65'); this.select();"  type="text" id="formularioLitle" style="width:98%; text-align:center ">
							...
							<?
								...
								while ($row = @mysql_fetch_array($dados)){
									...
									$out .= '<tr onclick="window.location.href = \'/joystock/cadastros/produtos.php?COD='.$row['COD_PRD'].'\';" bgcolor="'.$bgcolor.'" style="color:'.$color2.'; cursor:pointer;  font-size:11px" >'.
											...
											'<td  align="center" >'.$row['QTD_PRD'].'</td>'.
											'</tr>';
								}
