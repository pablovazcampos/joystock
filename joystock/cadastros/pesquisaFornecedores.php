<?
	...
	$colunas = new listaPesquisa("Pesquisa Fornecedores","/joystock/cadastros/fornecedores.php");
	...
	$query = "SELECT * FROM upcscln_tb T1 ".
			 "WHERE T1.EXC_UPCSCLN IS NULL AND ISS_FRN = '1' {$colunas->getWhere()} ORDER BY COD_CLN DESC LIMIT {$pag->getLimit()},{$linhas}";
						...
						<table width="100%" height="100%" cellpadding="0" cellspacing="0">
							<tr  style="position:relative;  " height="30px" width="100%" >
								<td valign="top" id="letra" style="font-size:30px; padding-left:10px " colspan="12" align="left">
									...
									<div style="float:left; padding-top:4px; width:360px">
										<?=$colunas->getTitulo()?>
									</div>
								</td>
