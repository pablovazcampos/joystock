<?php
	...
	$query = "SELECT T2.NME_PRD, NME_CLN, SUM(T1.QTD_PRD) AS QTD, SUM(T1.VLR_TPR) AS VLR FROM ".
			 ...
			 "WHERE T2.EXC_UPCSPRD IS NULL AND T1.TPO_MVM = '$tipo' $where GROUP BY T1.COD_PRD ORDER BY T1.COD_PRD DESC";
    ...
    $pdf->Cell(190,10,utf8_decode("Relatório Agregado de {$tp[$tipo]}"),0,1,'C',0,'');
