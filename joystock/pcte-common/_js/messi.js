...
function Messi(data, options) {
  ...
  if(_this.options.buttons.length > 0) {
    ...
    for (var i = 0; i < _this.options.buttons.length; i++) {
      ...
      var btn = jQuery('<div class="btnbox"><button class="btn2 ' + cls + '" href="#">' + _this.options.buttons[i].label + '</button></div>').data('value', _this.options.buttons[i].val);
...
jQuery.extend(Messi, {
  ...
  ask: function(data, callback, options) {
    ...
    var buttons = [
      {id: 'yes', label: 'Yes', val: 'Y', class: 'btn2-success'},
      {id: 'no', label: 'No', val: 'N', class: 'btn2-danger'},
    ];
