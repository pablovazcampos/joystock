<?php
	...
	$frmMaster			 = 'grupoClientes.php';							
	$NME_FRM 			 = 'index';
	$DSC_FRM             = 'Grupo de Clientes';
	$ACTION 			 = 'grupoClientes.php';
	$_SESSION['NME_RTN'] = "/joystock/cadastros/grupoClientes.php";
	$TABELA              = "upcsgcl_tb"; 
	
	
	require_once(PATH_FUNCAO."/CTRLReg.php");
	
	$select = "SELECT T1.COD_GCL,  T1.DSC_GCL ".
			  "FROM upcsgcl_tb T1 ".
			  "WHERE T1.EXC_UPCSGCL IS NULL";

	$_SESSION['query_lista'] = $select." ORDER BY DSC_GCL";
	
	$_SESSION['link_title'] = 'COD_GCL'; // fazer aparecer o title na lista
	
	/* Cria��o e Defini��o de colunas para lista */
	$_SESSION['prop'][0] = array('campo' => 'COD_GCL','format' => 'ZeroEsquerda','funcao' => '','link'=>'COD_GCL','propriedade' => 'vertical-align: top; text-align: center; width: 10%; font-size:100%;');
	$_SESSION['prop'][1] = array('campo' => 'DSC_GCL','funcao' => '','link'=>'COD_GCL','propriedade' => 'vertical-align: top; text-align: left; width: 45%; font-size:100%;');
	...
	<body>
		<center>
			...
			<table  style="margin-top:25px" id="LBL" width='100%'>
			  ...
			  <tr>	
			  	<td style="padding-top:15px" width="40%" align="right">Grupo:</td>
			  	<td style="padding-top:15px">
			  		<input maxlength="80" style="width:160px" <?=$CPO['DSC_GCL']?>  type='text' name='DSC_GCL'>
			  	</td>
			  </tr>
			  <tr>	
