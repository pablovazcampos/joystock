				...
				<div style="height:-webkit-calc(100% - 95px); width:100%; overflow-y:auto; overflow-x:hidden">
					<table width="100%" height="100%" cellpadding="0" cellspacing="0">
						<tr  style="position:relative;  height:45px " width="100%" >
							<td valign="top" id="letra" style="border-bottom:solid 2px #333; font-size:30px; padding-top:5px; " colspan="12" align="center">Relatório Detalhado de Vendas</td>
							<div style="position:absolute;right:5px; top:5px; padding:2px ">
								<img id="box1" title="Atualizar"    onclick="location.href='/joystock/relatorios/detalhado.php'" style="width:28px; cursor:pointer; height:28px;" src="/joystock/pcte-common/images/actualiser.png">
						...
						<tr style="height:30px">
							<td align="center" valign="top" id="letra" style="font-size:15px;  " colspan="12" align="left">
								<div style="float:left; text-align:left; width:20%;   padding:5px 0px 0px 5px" >
									Filtros:
								</div>
						...
						<tr style="height:100%">
							<td align="center">
								<iframe scrolling="No" src="pdfDetalhado.php?COD_CLN=<?=$_POST['COD_CLN']?>&NME_CLN=<?=$_POST['NME_CLN']?>&COD_GCL=<?=$_POST['COD_GCL']?>&DTA_VN1=<?=$_POST['DTA_VN1']?>&DTA_VN2=<?=$_POST['DTA_VN2']?>" name="FrmPrincipal" frameborder="0" border="0" height="100%" width="100%" ></iframe>
							</td>
						</tr>
						<tr >
							<td align="center">
