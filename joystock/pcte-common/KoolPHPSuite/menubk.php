<?php
	...
	while ($row = @mysql_fetch_array($dados)){
		...
		if ($row2 = @mysql_fetch_array($dados2)){
			$km->Add($row['PAI_MNU'],$row['IDN_MNU'],$row['NME_MNU'],$action,"/joystock/pcte-common/KoolPHPSuite/koolControls/KoolTreeView/icons/".$row['IMG_MNU']);
		}	
	}
...
<form id="form1" method="post">
	<div id="teste" style="padding-bottom:0px;width:1000px; ">
		<?php echo $km->Render();?>
	</div>
</form>
</html>