<?
	...
	$colunas = new listaPesquisa("Pesquisa de Produtos","/joystock/cadastros/produtos.php");
	...
	$colunas->criaColuna("QTD_PRD", $_POST['QTD_PRD'], "Estoque", "120", "valor", "", "", "center");
	...
	$query = "SELECT * FROM upcsprd_tb T1 ".
			 ...
			 "WHERE T1.EXC_UPCSPRD IS NULL AND TPO_PRD = '1' {$colunas->getWhere()} ORDER BY COD_PRD DESC LIMIT {$pag->getLimit()},{$linhas}";
