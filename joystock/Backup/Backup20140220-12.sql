...
CREATE TABLE `upcscdc_tb` (
  ...
  KEY `PSC_RNK` (`PSC_RNK`),
  KEY `IMG_CDC` (`IMG_CDC`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=227 COMMENT='CONTAS' ;
...
INSERT INTO upcscln_tb VALUES ( '1', '1', 'Pablo Campos da Silva', '1', '', '', '', '', '', '', '11', '', '', '(37)9958-2320', '', 'pablo@gmx.com.br', '2014-02-20', '2', '1', '', '1', '', '');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='MOVIMENTA��O DAS CONTAS' ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=862 COMMENT='MOVIMENTA��O' ;
...
INSERT INTO upcsprd_tb VALUES ( '1', '', 'Massa Aliment�cia de Milho Tivva', 'Massa alimentícia de milho com quinua tipo fusilli. Sem glúten, colesterol e gordura trans. 0% de Sódio.', '1', '0.00', '-1.0000', '1', '', '1', '123456', '1', '7', '8', '');
...
INSERT INTO upcsusr_tb VALUES ( '1', 'Marcelo Carvalho', 'comercial@implantarsolucoes.com.br', 'e10adc3949ba59abbe56e057f20f883e', '1', '');
