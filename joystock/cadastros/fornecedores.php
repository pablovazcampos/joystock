<?php
	...
	if($_POST["breg"] == "pesquisar"){
		header("Location: pesquisaFornecedores.php");
		$_POST["breg"] = "";
		exit();		
	}
	...
	$frmMaster			 = 'fornecedores.php';							
	$NME_FRM 			 = 'index';
	$DSC_FRM             = 'Cadastro de Fornecedores';
	$ACTION 			 = 'fornecedores.php';
	$_SESSION['NME_RTN'] = "/cadastro/fornecedores.php";
	$TABELA              = 'upcscln_tb';
	$WHERE               = " AND ISS_FRN = '1' ";
							...
							<tr  style='font-size:75%;'>
								<td   valign="top" style='font-weight:bold; padding-top:10px'  align="center" id='LBL'>
									<div style='float:center; text-align:left; width:570px;  padding:0 0px 0px 0px;'>
										...
										<div style='float:left; width:480px; padding:0 0px 0px 0px;'>
											Nome:<input  onkeydown='return handleEnter(this, event)'   style="width:480px; <?=$CPOStyle['NME_CLN']?>" id='formulario' name='NME_CLN' type='text' <?=$CPO['NME_CLN']?> >
										</div>
										...
										<div id="cnjID" style='position:relative; float:left; width:150px; padding:5px 5px 0px 0px;'>
